...
class Scanner(Greenlet):
    ...
    def get_tenders(self, params={}, direction=""):
        ...
        while not (params.get('descending') and not len(response.data)
                   and params.get('offset') == response.next_page.offset):
    ...
    def _start_synchronization_workers(self):
        ...
        self.jobs = [spawn(self.get_tenders_backward), spawn(self.get_tenders_forward)]
